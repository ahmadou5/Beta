        ...
        <>
          ...
          <div className="ml-6 mr-6 mt-20 lg:mt-28 lg:ml-14 lg:mr-14 flex flex-row mb-5 lg:mb-10 bg-inherit items-center  text-start text-ellipsis text-4xl">
            ...
            <div className=" hidden lg:flex text-sm ml-auto items-end">
              {<Web3Button className='w-96 ml-9 mr-9' icon="false" balance="show" label="Connect Wallet"/>}
              <div className="ml-2 mr-2">{ account.isConnected && <Web3NetworkSwitch/>}</div>
            </div>
          </div>
        </>
      );
        ...
        <div>
          <div className="w-[100%] h-auto lg:mt-9 mt-2 ">
            <div className="py-4 px-4 lg:flex lg:flex-row ">
              <div  style={{'backdrop-filter': 'blur(280px)'}} className="w-full bg-[#0B0E11] ml-auto mr-auto lg:w-[40%] shadow-lg bg-clip-padding bg-opacity-60 rounded-full py-0 px-0">
                <img
          ...
          <div style={{'backdrop-filter': 'blur(180px)'}} className="bg-[#0B0E11] mb-16 lg:h-96 w-full h-1/3 flex px-2 py-2 ml-auto mt-5 mr-auto lg:flex ">
            <div className=" ml-auto lg:mt-auto lg:mb-auto mr-auto w-full">
              <p className="text-white flex items-center ml-8 mr-8 mb-6 mt-5 text-3xl font-thin">YieldZone </p>
              <div className="flex  flex-col lg:items-start lg:flex-row mb-9 items-center">
                <div>
                  <p></p>
                </div>
